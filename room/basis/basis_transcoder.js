var BASIS = (function () {
  ...
  return (
    ...
    function (e) {
      ...
      f
        ? ((y = c ? require("path").dirname(y) + "/" : __dirname + "/"),
          (p = function (t, e) {
            return (
              h || (h = require("fs")),
              v || (v = require("path")),
        ...
        ? ("undefined" != typeof read &&
          ...
          (d = function (t) {
            ...
            return "function" == typeof readbuffer
              ...
              : (C("object" == typeof (e = read(t, "binary"))), e);
          }),
      ...
      (a = null),
        ...
        "object" != typeof WebAssembly && ct("no native wasm support detected");
      var b = !1;
      function C(t, e) {
      ...
      var S,
        ...
        D =
          "undefined" != typeof TextDecoder
            ...
            : void 0;
      function H(t, e) {
        for (var r = t, n = r >> 1, o = n + e / 2; !(n >= o) && k[n]; ) ++n;
        if ((r = n << 1) - t > 32 && D) return D.decode(W.subarray(t, r));
      ...
      function z(t) {
        (S = t),
          (o.HEAP8 = O = new Int8Array(t)),
          (o.HEAP16 = R = new Int16Array(t)),
          (o.HEAP32 = j = new Int32Array(t)),
          (o.HEAPU8 = W = new Uint8Array(t)),
          (o.HEAPU16 = k = new Uint16Array(t)),
          (o.HEAPU32 = I = new Uint32Array(t)),
          (o.HEAPF32 = U = new Float32Array(t)),
          (o.HEAPF64 = x = new Float64Array(t));
      }
      o.INITIAL_MEMORY;
      var L,
        Z = [],
      ...
      var ot = 0,
        ...
        at = null;
      function ut(t) {
        ot++, o.monitorRunDependencies && o.monitorRunDependencies(ot);
      }
      function st(t) {
        if (
          (ot--,
          o.monitorRunDependencies && o.monitorRunDependencies(ot),
          0 == ot && (null !== it && (clearInterval(it), (it = null)), at))
        ) {
          var e = at;
          (at = null), e();
        }
      ...
      function mt() {
        return g || (!s && !c) || "function" != typeof fetch || ht(vt)
          ? Promise.resolve().then(yt)
          : fetch(vt, {credentials: "same-origin"})
              .then(function (t) {
                if (!t.ok)
      ...
      function gt() {
        ...
        function e(t, e) {
          var r = t.exports;
          (o.asm = r), z((T = o.asm.H).buffer), (L = o.asm.I), st();
        }
        function r(t) {
          e(t.instance);
        }
        function i(e) {
          return mt()
            ...
            .then(e, function (t) {
              w("failed to asynchronously prepare wasm: " + t), ct(t);
            });
        }
        if ((ut(), o.instantiateWasm))
          try {
            return o.instantiateWasm(t, e);
          } catch (t) {
            return (
              w("Module.instantiateWasm callback failed with error: " + t), !1
            );
          }
        return (
          (g ||
          ...
          "function" != typeof fetch
            ? i(r)
            : fetch(vt, {credentials: "same-origin"}).then(function (e) {
      ...
      function bt(t) {
        return qr(t + wt.SIZE) + wt.SIZE;
      }
      function Ct(t) {
        (this.excPtr = t),
          (this.ptr = t - wt.SIZE),
          (this.set_type = function (t) {
            j[(this.ptr + wt.TYPE_OFFSET) >> 2] = t;
          }),
          (this.get_type = function () {
            return j[(this.ptr + wt.TYPE_OFFSET) >> 2];
          }),
          (this.set_destructor = function (t) {
            j[(this.ptr + wt.DESTRUCTOR_OFFSET) >> 2] = t;
          }),
          (this.get_destructor = function () {
            return j[(this.ptr + wt.DESTRUCTOR_OFFSET) >> 2];
          }),
          (this.set_refcount = function (t) {
            j[(this.ptr + wt.REFCOUNT_OFFSET) >> 2] = t;
          }),
          (this.set_caught = function (t) {
            (t = t ? 1 : 0), (O[(this.ptr + wt.CAUGHT_OFFSET) >> 0] = t);
          }),
          (this.get_caught = function () {
            return 0 != O[(this.ptr + wt.CAUGHT_OFFSET) >> 0];
          }),
          (this.set_rethrown = function (t) {
            (t = t ? 1 : 0), (O[(this.ptr + wt.RETHROWN_OFFSET) >> 0] = t);
          }),
          (this.get_rethrown = function () {
            return 0 != O[(this.ptr + wt.RETHROWN_OFFSET) >> 0];
          }),
          ...
          (this.add_ref = function () {
            var t = j[(this.ptr + wt.REFCOUNT_OFFSET) >> 2];
            j[(this.ptr + wt.REFCOUNT_OFFSET) >> 2] = t + 1;
          }),
          (this.release_ref = function () {
            var t = j[(this.ptr + wt.REFCOUNT_OFFSET) >> 2];
            return (j[(this.ptr + wt.REFCOUNT_OFFSET) >> 2] = t - 1), 1 === t;
          });
      }
      function $t(t, e, r) {
        throw (new Ct(t).init(e, r), t);
      }
      var Pt = {};
      function _t(t) {
        for (; t.length; ) {
      ...
      function xt(t, e, r) {
        function n(e) {
          var n = r(e);
          n.length !== t.length && Ut("Mismatched type converter count");
          for (var o = 0; o < t.length; ++o) Gt(t[o], n[o]);
        }
      ...
      function Gt(t, e, r) {
        ...
        if (
          (t ||
            qt('type "' + n + '" must have a positive integer typeid pointer'),
          Ft.hasOwnProperty(t))
        ) {
          if (r.ignoreDuplicateRegistrations) return;
          qt("Cannot register type '" + n + "' twice");
        }
        if (((Ft[t] = e), delete St[t], Et.hasOwnProperty(t))) {
          var o = Et[t];
          delete Et[t],
      ...
      function Lt(t) {
        if (!(this instanceof ce)) return !1;
      ...
      function te(t) {
        return "undefined" == typeof FinalizationGroup
          ? ((te = function (t) {
            ...
            t)
          : ((Jt = new FinalizationGroup(function (t) {
      ...
      function ee() {
        ...
        var t = te(
          Object.create(Object.getPrototypeOf(this), {$$: {value: Zt(this.$$)}})
        );
      ...
      function re() {
        this.$$.ptr || Yt(this),
          this.$$.deleteScheduled &&
            ...
            qt("Object already scheduled for deletion"),
          Xt(this),
          Qt(this.$$),
          this.$$.preservePointerOnDelete ||
      ...
      function ue() {
        return (
          ...
          this.$$.deleteScheduled &&
            ...
            qt("Object already scheduled for deletion"),
          ie.push(this),
          1 === ie.length && oe && oe(ae),
          (this.$$.deleteScheduled = !0),
          this
        );
      }
      function se() {
        (ce.prototype.isAliasOf = Lt),
          (ce.prototype.clone = ee),
          (ce.prototype.delete = re),
          (ce.prototype.isDeleted = ne),
          (ce.prototype.deleteLater = ue);
      }
      function ce() {}
      var fe = {};
      function le(t, e, r) {
      ...
      function pe(t, e, r) {
        o.hasOwnProperty(t)
          ? ((void 0 === r ||
              ...
              qt("Cannot register public name '" + t + "' twice"),
            le(o, t, t),
            o.hasOwnProperty(r) &&
              qt(
      ...
      function ve(t, e) {
        if (null === e)
          return this.isReference && qt("null is not a valid " + this.name), 0;
        e.$$ || qt('Cannot pass "' + ir(e) + '" as a ' + this.name),
          e.$$.ptr ||
            qt("Cannot pass deleted object as a pointer of type " + this.name);
        var r = e.$$.ptrType.registeredClass;
        return he(e.$$.ptr, r, this.registeredClass);
      }
      function ye(t, e) {
        var r;
        if (null === e)
          return (
            this.isReference && qt("null is not a valid " + this.name),
            this.isSmartPointer
        ...
        if (((r = he(e.$$.ptr, n, this.registeredClass)), this.isSmartPointer))
          switch (
            (void 0 === e.$$.smartPtr &&
              qt("Passing raw pointer to smart pointer is illegal"),
            this.sharingPolicy)
          ) {
            case 0:
              e.$$.smartPtrType === this
      ...
      function $e() {
        var t = [];
        for (var e in Ae) Ae.hasOwnProperty(e) && t.push(Ae[e]);
        return t;
      }
      function Pe(t) {
        (oe = t), ie.length && oe && oe(ae);
      }
      function _e() {
        (o.getInheritedInstanceCount = Ce),
          (o.getLiveInheritedInstances = $e),
          (o.flushPendingDeletes = ae),
          (o.setDelayFunction = Pe);
      }
      var Ae = {};
      function Ee(t, e) {
        for (void 0 === e && qt("ptr should not be undefined"); t.baseClass; )
          (e = t.upcast(e)), (t = t.baseClass);
        return e;
      }
      function Fe(t, e) {
        return (e = Ee(t, e)), Ae[e];
      }
      function Se(t, e) {
        return (
          (e.ptrType && e.ptr) ||
          ...
          (e.count = {value: 1}),
          te(Object.create(t, {$$: {value: e}}))
        );
      }
      function Oe(t) {
        var e = this.getPointee(t);
        if (!e) return this.destructor(t), null;
        var r = Fe(this.registeredClass, e);
        if (void 0 !== r) {
          if (0 === r.$$.count.value)
        ...
        var s = be(e, this.registeredClass, i.registeredClass);
        return null === s
          ? o.call(this)
          : this.isSmartPointer
          ...
          : Se(i.registeredClass.instancePrototype, {ptrType: i, ptr: s});
      }
      function We() {
        (Re.prototype.getPointee = ge),
          (Re.prototype.destructor = Te),
          (Re.prototype.argPackAdvance = 8),
          (Re.prototype.readValueFromPointer = At),
          (Re.prototype.deleteObject = we),
          (Re.prototype.fromWireType = Oe);
      }
      ...
      function ke(t, e, r) {
        o.hasOwnProperty(t) || Ut("Replacing nonexistant public symbol"),
      ...
      function je(t, e, r) {
        return r && r.length
          ? o["dynCall_" + t].apply(null, [e].concat(r))
          : o["dynCall_" + t].call(null, e);
      }
      function Ie(t, e, r) {
        return -1 != t.indexOf("j") ? je(t, e, r) : L.get(e).apply(null, r);
      }
      function Ue(t, e) {
        C(
          t.indexOf("j") >= 0,
      ...
      function xe(t, e) {
        var r = -1 != (t = Vt(t)).indexOf("j") ? Ue(t, e) : L.get(e);
        return (
          "function" != typeof r &&
            qt("unknown function pointer with signature " + t + ": " + e),
          r
        );
      }
      var De = void 0;
      ...
      function Be(t, e, r, n, o, i, a, u, s, c, f, l, p) {
        ...
        var d = Rt(f);
        pe(d, function () {
          Ne("Cannot construct " + f + " due to unbound types", [n]);
        }),
          xt([t, e, r], n ? [n] : [], function (e) {
            ...
            a.prototype = s;
            var l = new de(f, a, s, p, r, i, u, c),
              h = new Re(f, l, !0, !1, !1),
              v = new Re(f + "*", l, !1, !1, !1),
              y = new Re(f + " const*", l, !1, !0, !1);
            return (
              (fe[t] = {pointerType: v, constPointerType: y}),
              ke(d, a),
              [h, v, y]
            );
          });
        ...
        xt([], [t], function (t) {
          ...
          return (
            (t.registeredClass.constructor_body[e - 1] = function () {
              Ne("Cannot construct " + t.name + " due to unbound types", a);
            }),
            xt([], a, function (n) {
              return (
                (t.registeredClass.constructor_body[e - 1] = function () {
                  arguments.length !== e - 1 &&
                    ...
                    (u.length = e);
                  for (var t = 1; t < e; ++t)
                    u[t] = n[t].toWireType(s, arguments[t - 1]);
                  var i = o.apply(null, u);
                  return _t(s), n[0].fromWireType(i);
                }),
                []
              );
            }),
        ...
        if (
          ...
          for (s = a ? 1 : 2; s < e.length; ++s) {
            ...
            null !== e[s].destructorFunction &&
              ((p += y + "_dtor(" + y + "); // " + e[s].name + "\n"),
              h.push(y + "_dtor"),
              v.push(e[s].destructorFunction));
          }
        return (
          c && (p += "var ret = retType.fromWireType(rv);\nreturn ret;\n"),
          (p += "}\n"),
          h.push(p),
          qe(Function, h).apply(null, v)
        );
      }
      function ze(t, e, r, n, o, i, a, u) {
        ...
        (e = Vt(e)),
          ...
          xt([], [t], function (t) {
            var n = (t = t[0]).name + "." + e;
            function o() {
              Ne("Cannot call " + n + " due to unbound types", s);
            }
            ...
            return (
              ...
              (void 0 === f.overloadTable &&
                ...
                : (le(c, e, n), (c[e].overloadTable[r - 2] = o)),
              xt([], s, function (o) {
                var u = Ge(n, o, t, i, a);
                return (
      ...
      var Le = [],
        Ze = [{}, {value: void 0}, {value: null}, {value: !0}, {value: !1}];
      function Ye(t) {
        t > 4 && 0 == --Ze[t].refcount && ((Ze[t] = void 0), Le.push(t));
      }
      function Je() {
        for (var t = 0, e = 5; e < Ze.length; ++e) void 0 !== Ze[e] && ++t;
        return t;
      }
      function Xe() {
        for (var t = 5; t < Ze.length; ++t) if (void 0 !== Ze[t]) return Ze[t];
        return null;
      }
      function Ke() {
        (o.count_emval_handles = Je), (o.get_first_emval = Xe);
      }
      function Qe(t) {
        switch (t) {
          case void 0:
          ...
          case !1:
            return 4;
          default:
            var e = Le.length ? Le.pop() : Ze.length;
            return (Ze[e] = {refcount: 1, value: t}), e;
        }
      }
      function tr(t, e) {
        Gt(t, {
      ...
      function nr(t, e) {
        var r = Ft[t];
        return void 0 === r && qt(e + " has unknown type " + He(t)), r;
      }
      function or(t, e, r) {
        var n = nr(t, "enum");
        e = Vt(e);
        var o = n.constructor,
          i = Object.create(n.constructor.prototype, {
            value: {value: r},
            constructor: {value: kt(n.name + "_" + e, function () {})}
          });
        (o.values[r] = i), (o[e] = i);
      }
      function ir(t) {
        ...
        Gt(t, {
          ...
          toWireType: function (t, e) {
            if ("number" != typeof e && "boolean" != typeof e)
              throw new TypeError(
                'Cannot convert "' + ir(e) + '" to ' + this.name
              );
            return e;
          },
          argPackAdvance: 8,
          readValueFromPointer: ar(e, n),
          destructorFunction: null
        });
      }
      function sr(t, e, r, n, o, i) {
        ...
        (t = Vt(t)),
          ...
          pe(
            t,
            function () {
              Ne("Cannot call " + t + " due to unbound types", a);
            },
            e - 1
          ),
          xt([], a, function (r) {
            var n = [r[0], null].concat(r.slice(1));
            return ke(t, Ge(t, n, null, o, i), e - 1), [];
          });
      }
      function cr(t, e, r) {
        switch (e) {
        ...
        Gt(t, {
          ...
          toWireType: function (t, r) {
            if ("number" != typeof r && "boolean" != typeof r)
              throw new TypeError(
                'Cannot convert "' + ir(r) + '" to ' + this.name
              );
            if (r < n || r > o)
              throw new TypeError(
                'Passing a number "' +
        ...
        Gt(t, {
          ...
          fromWireType: function (t) {
            ...
            if (r)
              ...
              var s = new Array(n);
              for (i = 0; i < n; ++i) s[i] = String.fromCharCode(W[t + 4 + i]);
              e = s.join("");
            }
            return Gr(t), e;
          },
          toWireType: function (t, e) {
            ...
            n ||
              ...
              qt("Cannot pass non-string to std::string");
            var o = (
                r && n
                  ? function () {
                      return F(e);
              ...
              i = qr(4 + o + 1);
            if (((I[i >> 2] = o), r && n)) E(e, i + 4, o + 1);
            else if (n)
              for (var a = 0; a < o; ++a) {
                var u = e.charCodeAt(a);
                u > 255 &&
                  (Gr(i),
                  qt("String has UTF-16 code units that do not fit in 8 bits")),
                  (W[i + 4 + a] = u);
              }
            else for (a = 0; a < o; ++a) W[i + 4 + a] = e[a];
            return null !== t && t.push(Gr, i), i;
          },
          argPackAdvance: 8,
          readValueFromPointer: At,
        ...
        (r = Vt(r)),
          ...
          Gt(t, {
            ...
            toWireType: function (t, n) {
              "string" != typeof n &&
                qt("Cannot pass non-string to C++ string type " + r);
              var i = a(n),
                s = qr(4 + i + e);
              return (
                (I[s >> 2] = i >> u),
      ...
      function vr(t, e, r, n, o, i, a, u, s, c) {
        Pt[t].fields.push({
          fieldName: Vt(e),
          getterReturnType: r,
          getter: xe(n, o),
      ...
      function mr(t) {
        return t || qt("Cannot use deleted val. handle = " + t), Ze[t].value;
      }
      function gr(t, e, r) {
        (t = mr(t)), (e = nr(e, "emval::as"));
        var n = [],
          o = Qe(n);
        return (j[r >> 2] = o), e.toWireType(n, t);
      }
      var Tr = {};
      function wr(t) {
        var e = Tr[t];
        return void 0 === e ? Vt(t) : e;
      }
      var br = [];
      function Cr(t, e, r, n) {
        (t = br[t])((e = mr(e)), (r = wr(r)), null, n);
      }
      function $r() {
      ...
      function Er(t, e) {
        ...
        return (
          ...
          (c += "};\n"),
          i.push(c),
          _r(qe(Function, i).apply(null, a))
        );
      }
      function Fr(t) {
        return (t = wr(t)), Qe(o[t]);
      }
      function Sr(t, e) {
        return Qe((t = mr(t))[(e = mr(e))]);
      }
      function Or(t) {
        t > 4 && (Ze[t].refcount += 1);
      }
      ...
      function kr(t, e, r, n) {
        t = mr(t);
        var o = Rr[e];
        return o || ((o = Wr(e)), (Rr[e] = o)), o(t, r, n);
      }
      function jr(t) {
        return Qe(wr(t));
      }
      ...
      function Hr(t) {
        try {
          return T.grow((t - S.byteLength + 65535) >>> 16), z(T.buffer), 1;
        } catch (t) {}
      }
      function Nr(t) {
        t >>>= 0;
        ...
        for (var n = 1; n <= 4; n *= 2) {
          ...
          if (
            ...
            Hr(Math.min(r, G(Math.max(16777216, t, o), 65536))))
          )
            return !0;
        }
        return !1;
      }
      (It = o.InternalError = jt(Error, "InternalError")),
        Nt(),
        (Mt = o.BindingError = jt(Error, "BindingError")),
        se(),
        We(),
        _e(),
        (De = o.UnboundTypeError = jt(Error, "UnboundTypeError")),
        Ke(),
        Y.push({
          func: function () {
            Mr();
      ...
      var Br,
        ...
        Mr =
          ...
          (o.___wasm_call_ctors = function () {
            return (Mr = o.___wasm_call_ctors = o.asm.J).apply(null, arguments);
          })),
        qr = (o._malloc = function () {
          return (qr = o._malloc = o.asm.K).apply(null, arguments);
        }),
        Gr = (o._free = function () {
          return (Gr = o._free = o.asm.L).apply(null, arguments);
        }),
        zr = (o.___getTypeName = function () {
          return (zr = o.___getTypeName = o.asm.M).apply(null, arguments);
        });
      function Lr(t) {
